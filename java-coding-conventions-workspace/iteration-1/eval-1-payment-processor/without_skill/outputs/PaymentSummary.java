...
public class PaymentSummary {
    ...
    public PaymentSummary(final String customerId, final double totalCharged, final double totalFees,
                          final int successfulCount, final int failedCount, final List<String> failureReasons) {
