...
public class NotificationConfig {
    ...
    public NotificationConfig(final String defaultChannel,
        ...
        this.enabledChannels = copyUnmodifiable(enabledChannels);
        this.channelSettings = copyUnmodifiable(channelSettings);
    ...
    private static List<String> copyUnmodifiable(final List<String> source) {
        return Collections.unmodifiableList(new ArrayList<>(source));
    }

    private static Map<String, String> copyUnmodifiable(final Map<String, String> source) {
